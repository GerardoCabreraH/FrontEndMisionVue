            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <h1 class="text-center">Modificacion del adorno trozos de chocolate</h1>
                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <InformacionAdorno>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" placeholder="Nombre"
                                                    class="form-control" value="Trozos de chocolate">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <router-link class="btn btn-primary btn-block" to="/admin/productos/ver/m00522">Regresar</router-link>
...
export default {
    name: 'AdornoTrozosChocolateEditView',
