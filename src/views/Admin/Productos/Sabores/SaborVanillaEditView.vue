            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <h1 class="text-center">Modificacion del sabor vanilla</h1>
                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <InformacionSabor>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" placeholder="Nombre"
                                                    class="form-control" value="Vanilla">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" id="description" name="description" rows="5"
                                                    placeholder="Descripción" class="form-control">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <router-link class="btn btn-primary btn-block" to="/admin/productos/ver/m00122">Regresar</router-link>
