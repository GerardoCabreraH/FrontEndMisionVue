            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <h1 class="text-center">Modificacion del sabor chocolate</h1>
                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <InformacionSabor>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" placeholder="Nombre"
                                                    class="form-control" value="Chocolate">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <router-link class="btn btn-primary btn-block" to="/admin/productos/ver/m00222">Regresar</router-link>
